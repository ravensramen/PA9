...
//    sf::Texture forwardTexture, leftTexture, rightTexture, deadTexture, jetFrontTexture;
//
...
//        }
//        if ((sf::Keyboard::isKeyPressed(sf::Keyboard::Scan::Up))&& checkpointReached&&j1.isPickedUp()) {
